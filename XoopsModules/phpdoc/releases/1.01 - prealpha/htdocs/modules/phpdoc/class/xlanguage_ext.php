...
class PhpdocXlanguage_ext extends XoopsObject
{

    function PhpdocXlanguage_ext($id = null)
    {
...
class PhpdocXlanguage_extHandler extends XoopsPersistableObjectHandler
{
    function __construct($db) 
    {
		$this->db = $db;
        parent::__construct($db, "xlanguage_ext", 'PhpdocXlanguage_ext', "lang_id", "lang_name");
    }
