 ...
 *
 * @copyright       The XOOPS Class http://sourceforge.net/classs/xoops/
 ...
 * @access 		public
 */
class XoopsFormSelectClass extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectClass($caption, $name, $value = null, $size = 1, $multiple = false, $criteria=false, $none = true)
    {
		...
		foreach($classs as $classid => $obj) 
			$this->addOption($classid, $obj->getVar('name'));
    }
