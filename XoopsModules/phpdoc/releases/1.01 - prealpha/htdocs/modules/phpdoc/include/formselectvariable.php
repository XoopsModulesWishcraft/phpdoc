...
Description: Multilingual Content Module with tags and lists with search variables
 ...
 *
 * @copyright       The XOOPS Variable http://sourceforge.net/projects/xoops/
 ...
 * @access 		public
 */
class XoopsFormSelectVariable extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectVariable($caption, $name, $value = null, $size = 1, $multiple = false, $criteria=false, $none = true)
    {
		...
		foreach($variables as $variableid => $obj) 
			$this->addOption($variableid, $obj->getVar('name'));
    }
