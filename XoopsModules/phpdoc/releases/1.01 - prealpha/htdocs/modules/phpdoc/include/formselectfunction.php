 ...
 *
 * @copyright       The XOOPS Function http://sourceforge.net/projects/xoops/
 ...
 * @access 		public
 */
class XoopsFormSelectFunction extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectFunction($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0, $none = true)
    {
		...
		foreach($functions as $functionid => $obj) 
			$this->addOption($functionid, $obj->getVar('name'));
    }
