 ...
 * @access 		public
 */
class XoopsFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'phpdoc');
