...
class XoopsFormSelectMode extends XoopsFormElement
{
     ...
     */
    function XoopsFormSelectMode($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_MI_PHPDOC_MODE_PUBLIC','_MI_PHPDOC_MODE_PRIVATE','_MI_PHPDOC_MODE_PROTECTED') as $item)
