...
/**
 *  Xoops Form File Elements
 *
 * @copyright       The XOOPS File http://sourceforge.net/files/xoops/
 ...
 * @access 		public
 */
class XoopsFormSelectFile extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectFile($caption, $name, $value = null, $size = 1, $multiple = false, $criteria = false, $none = true)
    {
		...
		foreach($files as $fileid => $obj) 
			$this->addOption($fileid, $obj->getVar('filename'));
    }
